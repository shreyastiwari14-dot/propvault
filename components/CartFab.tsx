...
export default function CartFab() {
  ...
  return (
    <motion.button
      ...
      whileTap={{ scale: 0.95 }}
      className="fixed bottom-6 right-6 z-30 flex items-center gap-2.5 bg-[#C8902A] hover:bg-[#B8801E] text-white pl-4 pr-3 py-3 rounded-full shadow-2xl shadow-[#C8902A]/20 transition-colors"
    >
